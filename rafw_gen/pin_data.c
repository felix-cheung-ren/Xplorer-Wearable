...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] = { { .pin = BSP_IO_PORT_00_PIN_00,
		...
		.pin_cfg = (GPIO_W_CFG_ANALOG_ENABLE | GPIO_W_CFG_DRV_8mA
				| GPIO_W_CFG_SLW_SLOW) }, { .pin = BSP_IO_PORT_00_PIN_04,
		.pin_cfg = (GPIO_W_CFG_DRV_8mA | GPIO_W_CFG_PERIPHERAL_PIN
				| GPIO_W_CFG_PORT_DIRECTION_INPUT | GPIO_W_CFG_SLW_FAST
				| GPIO_W_PERIPHERAL_UART2_RX) }, { .pin = BSP_IO_PORT_00_PIN_05,
		.pin_cfg = (GPIO_W_CFG_DRV_8mA | GPIO_W_CFG_PERIPHERAL_PIN
				| GPIO_W_CFG_PORT_DIRECTION_OUTPUT | GPIO_W_CFG_SLW_FAST
				| GPIO_W_PERIPHERAL_UART2_TX) }, { .pin = BSP_IO_PORT_00_PIN_06,
		.pin_cfg = (GPIO_W_CFG_DRV_8mA | GPIO_W_CFG_IRQ_ENABLE
				| GPIO_W_CFG_PERIPHERAL_PIN | GPIO_W_CFG_PORT_DIRECTION_INPUT
				| GPIO_W_CFG_SLW_FAST) }, { .pin = BSP_IO_PORT_00_PIN_07,
		.pin_cfg = (GPIO_W_CFG_DRV_8mA | GPIO_W_CFG_PERIPHERAL_PIN
				| GPIO_W_CFG_PORT_DIRECTION_INPUT | GPIO_W_CFG_SLW_FAST
				| GPIO_W_PERIPHERAL_I2C_SDA) }, { .pin = BSP_IO_PORT_00_PIN_08,
		.pin_cfg = (GPIO_W_CFG_DRV_8mA | GPIO_W_CFG_PERIPHERAL_PIN
				| GPIO_W_CFG_PORT_DIRECTION_OUTPUT | GPIO_W_CFG_SLW_FAST
				| GPIO_W_PERIPHERAL_UART2_RTSN) }, { .pin =
		BSP_IO_PORT_00_PIN_09, .pin_cfg = (GPIO_W_CFG_DRV_8mA
		| GPIO_W_CFG_PERIPHERAL_PIN | GPIO_W_CFG_PORT_DIRECTION_INPUT
		| GPIO_W_CFG_SLW_FAST | GPIO_W_PERIPHERAL_UART2_CTSN) }, { .pin =
		...
		.pin = BSP_IO_PORT_00_PIN_13, .pin_cfg = (GPIO_W_CFG_DRV_8mA
				| GPIO_W_CFG_IRQ_ENABLE | GPIO_W_CFG_PERIPHERAL_PIN
				| GPIO_W_CFG_PORT_DIRECTION_INPUT | GPIO_W_CFG_SLW_FAST) }, {
		.pin = BSP_IO_PORT_01_PIN_04, .pin_cfg = (GPIO_W_CFG_DRV_8mA
				| GPIO_W_CFG_PERIPHERAL_PIN | GPIO_W_CFG_PORT_DIRECTION_INPUT
				| GPIO_W_CFG_SLW_FAST) }, { .pin = BSP_IO_PORT_01_PIN_05,
		.pin_cfg = (GPIO_W_CFG_DRV_8mA | GPIO_W_CFG_PERIPHERAL_PIN
				| GPIO_W_CFG_PORT_DIRECTION_INPUT | GPIO_W_CFG_SLW_FAST) }, {
