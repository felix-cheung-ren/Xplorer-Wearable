...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] = { { .pin = BSP_IO_PORT_00_PIN_00,
		...
		.pin_cfg = (GPIO_W_CFG_ANALOG_ENABLE | GPIO_W_CFG_DRV_8mA
				| GPIO_W_CFG_SLW_SLOW) }, { .pin = BSP_IO_PORT_00_PIN_05,
		.pin_cfg = (GPIO_W_CFG_DRV_8mA | GPIO_W_CFG_PORT_DIRECTION_OUTPUT
				| GPIO_W_CFG_PORT_OUTPUT_HIGH | GPIO_W_CFG_SLW_SLOW) }, { .pin =
		BSP_IO_PORT_00_PIN_06, .pin_cfg = (GPIO_W_CFG_DRV_8mA
		| GPIO_W_CFG_IRQ_ENABLE | GPIO_W_CFG_PERIPHERAL_PIN
		| GPIO_W_CFG_PORT_DIRECTION_INPUT | GPIO_W_CFG_SLW_FAST) }, { .pin =
		BSP_IO_PORT_00_PIN_07, .pin_cfg = (GPIO_W_CFG_DRV_8mA
		| GPIO_W_CFG_PERIPHERAL_PIN | GPIO_W_CFG_PORT_DIRECTION_INPUT
		| GPIO_W_CFG_SLW_FAST | GPIO_W_PERIPHERAL_I2C_SDA) }, { .pin =
		BSP_IO_PORT_00_PIN_10, .pin_cfg = (GPIO_W_CFG_DRV_8mA
		| GPIO_W_CFG_PERIPHERAL_PIN | GPIO_W_CFG_PORT_DIRECTION_INPUT
		| GPIO_W_CFG_SLW_FAST | GPIO_W_PERIPHERAL_I2C_SCL) }, { .pin =
		BSP_IO_PORT_00_PIN_11, .pin_cfg = (GPIO_W_CFG_DRV_8mA
		| GPIO_W_CFG_IRQ_ENABLE | GPIO_W_CFG_PERIPHERAL_PIN
		| GPIO_W_CFG_PORT_DIRECTION_INPUT | GPIO_W_CFG_PULLUP_ENABLE
		| GPIO_W_CFG_SLW_FAST) }, { .pin = BSP_IO_PORT_00_PIN_12, .pin_cfg =
		(GPIO_W_CFG_DRV_8mA | GPIO_W_CFG_IRQ_ENABLE | GPIO_W_CFG_PERIPHERAL_PIN
				| GPIO_W_CFG_PORT_DIRECTION_INPUT | GPIO_W_CFG_SLW_FAST) }, {
		.pin = BSP_IO_PORT_00_PIN_13, .pin_cfg = (GPIO_W_CFG_DRV_8mA
				| GPIO_W_CFG_IRQ_ENABLE | GPIO_W_CFG_PERIPHERAL_PIN
				| GPIO_W_CFG_PORT_DIRECTION_INPUT | GPIO_W_CFG_SLW_FAST) }, {
		.pin = BSP_IO_PORT_01_PIN_00, .pin_cfg = (GPIO_W_CFG_DRV_8mA
				| GPIO_W_CFG_PERIPHERAL_PIN | GPIO_W_CFG_PORT_DIRECTION_INPUT
				| GPIO_W_CFG_SLW_FAST | GPIO_W_PERIPHERAL_SPI_DI) }, { .pin =
		BSP_IO_PORT_01_PIN_04, .pin_cfg = (GPIO_W_CFG_DRV_8mA
		| GPIO_W_CFG_PERIPHERAL_PIN | GPIO_W_CFG_PORT_DIRECTION_INPUT
		| GPIO_W_CFG_SLW_FAST) }, { .pin = BSP_IO_PORT_01_PIN_05, .pin_cfg =
		(GPIO_W_CFG_DRV_8mA | GPIO_W_CFG_PERIPHERAL_PIN
				| GPIO_W_CFG_PORT_DIRECTION_INPUT | GPIO_W_CFG_SLW_FAST) }, {
		.pin = BSP_IO_PORT_01_PIN_06, .pin_cfg = (GPIO_W_CFG_DRV_8mA
				| GPIO_W_CFG_PERIPHERAL_PIN | GPIO_W_CFG_PORT_DIRECTION_INPUT
				| GPIO_W_CFG_SLW_FAST) }, { .pin = BSP_IO_PORT_01_PIN_07,
		.pin_cfg = (GPIO_W_CFG_DRV_8mA | GPIO_W_CFG_PERIPHERAL_PIN
				| GPIO_W_CFG_PORT_DIRECTION_INPUT | GPIO_W_CFG_SLW_FAST) }, {
		.pin = BSP_IO_PORT_01_PIN_08, .pin_cfg = (GPIO_W_CFG_DRV_8mA
				| GPIO_W_CFG_PERIPHERAL_PIN | GPIO_W_CFG_PORT_DIRECTION_OUTPUT
				| GPIO_W_CFG_SLW_FAST) }, { .pin = BSP_IO_PORT_01_PIN_09,
		.pin_cfg = (GPIO_W_CFG_DRV_8mA | GPIO_W_CFG_PERIPHERAL_PIN
				| GPIO_W_CFG_PORT_DIRECTION_OUTPUT | GPIO_W_CFG_SLW_FAST) }, {
		.pin = BSP_IO_PORT_01_PIN_11, .pin_cfg = (GPIO_W_CFG_DRV_8mA
				| GPIO_W_CFG_PORT_DIRECTION_OUTPUT | GPIO_W_CFG_PORT_OUTPUT_HIGH
				| GPIO_W_CFG_SLW_SLOW) }, { .pin = BSP_IO_PORT_01_PIN_12,
		.pin_cfg = (GPIO_W_CFG_DRV_8mA | GPIO_W_CFG_PORT_DIRECTION_OUTPUT
				| GPIO_W_CFG_PORT_OUTPUT_HIGH | GPIO_W_CFG_SLW_SLOW) }, { .pin =
		BSP_IO_PORT_01_PIN_13, .pin_cfg = (GPIO_W_CFG_DRV_8mA
		| GPIO_W_CFG_PORT_DIRECTION_OUTPUT | GPIO_W_CFG_PORT_OUTPUT_LOW
		| GPIO_W_CFG_SLW_SLOW) }, { .pin = BSP_IO_PORT_01_PIN_14, .pin_cfg =
		(GPIO_W_CFG_DRV_8mA | GPIO_W_CFG_PERIPHERAL_PIN | GPIO_W_CFG_SLW_FAST
				| GPIO_W_PERIPHERAL_SPI_DO) }, { .pin = BSP_IO_PORT_01_PIN_15,
		.pin_cfg = (GPIO_W_CFG_DRV_8mA | GPIO_W_CFG_PERIPHERAL_PIN
				| GPIO_W_CFG_PORT_DIRECTION_OUTPUT | GPIO_W_CFG_SLW_FAST
				| GPIO_W_PERIPHERAL_SPI_CLK) }, { .pin = BSP_IO_PORT_01_PIN_16,
		.pin_cfg = (GPIO_W_CFG_PERIPHERAL_PIN | GPIO_W_CFG_PORT_DIRECTION_INPUT
				| GPIO_W_PERIPHERAL_SWCLK) }, { .pin = BSP_IO_PORT_01_PIN_17,
		.pin_cfg = (GPIO_W_CFG_PERIPHERAL_PIN | GPIO_W_CFG_PORT_DIRECTION_INPUT
