...
void phy_rc_isr(void);
        ...
        #define VECTOR_NUMBER_DMACW_IRQ ((IRQn_Type) 0) /* DMACW IRQ (General Purpose DMA interrupt) */
        #define DMACW_IRQ_IRQn          ((IRQn_Type) 0) /* DMACW IRQ (General Purpose DMA interrupt) */
        ...
        #define VECTOR_NUMBER_I2CW1_IRQ ((IRQn_Type) 4) /* I2CW1 IRQ (Generic interrupt) */
        #define I2CW1_IRQ_IRQn          ((IRQn_Type) 4) /* I2CW1 IRQ (Generic interrupt) */
        #define VECTOR_NUMBER_SPIW1_IRQ ((IRQn_Type) 5) /* SPIW1 IRQ (Generic interrupt) */
        #define SPIW1_IRQ_IRQn          ((IRQn_Type) 5) /* SPIW1 IRQ (Generic interrupt) */
        #define VECTOR_NUMBER_WIFI_TDES_CBC_IRQ ((IRQn_Type) 6) /* WIFI TDES CBC IRQ (TDES interrupt) */
        #define WIFI_TDES_CBC_IRQ_IRQn          ((IRQn_Type) 6) /* WIFI TDES CBC IRQ (TDES interrupt) */
        #define VECTOR_NUMBER_WIFI_PSK_SHA1_IRQ ((IRQn_Type) 7) /* WIFI PSK SHA1 IRQ (PSK SHA1 interrupt) */
        #define WIFI_PSK_SHA1_IRQ_IRQn          ((IRQn_Type) 7) /* WIFI PSK SHA1 IRQ (PSK SHA1 interrupt) */
        #define VECTOR_NUMBER_WIFI_SYSPLL_LOCK_IRQ ((IRQn_Type) 8) /* WIFI SYSPLL LOCK IRQ (PLL480M lock interrupt) */
        #define WIFI_SYSPLL_LOCK_IRQ_IRQn          ((IRQn_Type) 8) /* WIFI SYSPLL LOCK IRQ (PLL480M lock interrupt) */
        #define VECTOR_NUMBER_WIFI_RTCW_EXTWK_IRQ ((IRQn_Type) 9) /* WIFI RTCW EXTWK IRQ (External wakeup interrupt) */
        #define WIFI_RTCW_EXTWK_IRQ_IRQn          ((IRQn_Type) 9) /* WIFI RTCW EXTWK IRQ (External wakeup interrupt) */
        #define VECTOR_NUMBER_WIFI_RTCW_BLACK_IRQ ((IRQn_Type) 10) /* WIFI RTCW BLACK IRQ (Voltage blackout interrupt) */
        #define WIFI_RTCW_BLACK_IRQ_IRQn          ((IRQn_Type) 10) /* WIFI RTCW BLACK IRQ (Voltage blackout interrupt) */
        #define VECTOR_NUMBER_WIFI_RTCW_BROWN_IRQ ((IRQn_Type) 11) /* WIFI RTCW BROWN IRQ (Voltage brownout interrupt) */
        #define WIFI_RTCW_BROWN_IRQ_IRQn          ((IRQn_Type) 11) /* WIFI RTCW BROWN IRQ (Voltage brownout interrupt) */
        #define VECTOR_NUMBER_WIFI_RTCW_PCNT_IRQ ((IRQn_Type) 12) /* WIFI RTCW PCNT IRQ (Pulse count interrupt) */
        #define WIFI_RTCW_PCNT_IRQ_IRQn          ((IRQn_Type) 12) /* WIFI RTCW PCNT IRQ (Pulse count interrupt) */
        #define VECTOR_NUMBER_WIFI_RTCW_BCF_MSR_IRQ ((IRQn_Type) 13) /* WIFI RTCW BCF MSR IRQ (Bus clock measure interrupt) */
        #define WIFI_RTCW_BCF_MSR_IRQ_IRQn          ((IRQn_Type) 13) /* WIFI RTCW BCF MSR IRQ (Bus clock measure interrupt) */
        #define VECTOR_NUMBER_WIFI_RTCW_RTC_ACC_IRQ ((IRQn_Type) 14) /* WIFI RTCW RTC ACC IRQ (Access to RTC Core interrupt) */
        #define WIFI_RTCW_RTC_ACC_IRQ_IRQn          ((IRQn_Type) 14) /* WIFI RTCW RTC ACC IRQ (Access to RTC Core interrupt) */
        #define VECTOR_NUMBER_WIFI_RTCW_EXP_IRQ ((IRQn_Type) 15) /* WIFI RTCW EXP IRQ (RTC mirror Free running count interrupt) */
        #define WIFI_RTCW_EXP_IRQ_IRQn          ((IRQn_Type) 15) /* WIFI RTCW EXP IRQ (RTC mirror Free running count interrupt) */
        #define VECTOR_NUMBER_WIFI_RTCW_LMR_IRQ ((IRQn_Type) 16) /* WIFI RTCW LMR IRQ (FRC to mirroring loading done interrupt) */
        #define WIFI_RTCW_LMR_IRQ_IRQn          ((IRQn_Type) 16) /* WIFI RTCW LMR IRQ (FRC to mirroring loading done interrupt) */
        #define VECTOR_NUMBER_WIFI_MRM_IRQ ((IRQn_Type) 17) /* WIFI MRM IRQ (Instruction cache Miss Rate Monitor interrupt) */
        #define WIFI_MRM_IRQ_IRQn          ((IRQn_Type) 17) /* WIFI MRM IRQ (Instruction cache Miss Rate Monitor interrupt) */
        #define VECTOR_NUMBER_WIFI_DCACHE_MRM_IRQ ((IRQn_Type) 18) /* WIFI DCACHE MRM IRQ (Data cache Miss Rate Monitor interrupt) */
        #define WIFI_DCACHE_MRM_IRQ_IRQn          ((IRQn_Type) 18) /* WIFI DCACHE MRM IRQ (Data cache Miss Rate Monitor interrupt) */
        #define VECTOR_NUMBER_CC_IRQ ((IRQn_Type) 19) /* CC IRQ (CryptoCell-312 interrupt) */
        #define CC_IRQ_IRQn          ((IRQn_Type) 19) /* CC IRQ (CryptoCell-312 interrupt) */
        #define VECTOR_NUMBER_EXTIRQW_P0_IRQ ((IRQn_Type) 20) /* EXTIRQW P0 IRQ (GPIO port 0 toggle interrupt (External Interrupt)) */
        #define EXTIRQW_P0_IRQ_IRQn          ((IRQn_Type) 20) /* EXTIRQW P0 IRQ (GPIO port 0 toggle interrupt (External Interrupt)) */
        #define VECTOR_NUMBER_EXTIRQW_P1_IRQ ((IRQn_Type) 21) /* EXTIRQW P1 IRQ (GPIO port 1 toggle interrupt (External Interrupt)) */
        #define EXTIRQW_P1_IRQ_IRQn          ((IRQn_Type) 21) /* EXTIRQW P1 IRQ (GPIO port 1 toggle interrupt (External Interrupt)) */
        #define VECTOR_NUMBER_WIFI_FPLL_LOCK_IRQ ((IRQn_Type) 22) /* WIFI FPLL LOCK IRQ (FPLL lock interrupt) */
        #define WIFI_FPLL_LOCK_IRQ_IRQn          ((IRQn_Type) 22) /* WIFI FPLL LOCK IRQ (FPLL lock interrupt) */
        #define VECTOR_NUMBER_WIFI_HSU_IRQ ((IRQn_Type) 23) /* WIFI HSU IRQ (WIFI Hardware Security Unit interrupt) */
        #define WIFI_HSU_IRQ_IRQn          ((IRQn_Type) 23) /* WIFI HSU IRQ (WIFI Hardware Security Unit interrupt) */
        #define VECTOR_NUMBER_WIFI_MACTIMER_IRQ ((IRQn_Type) 24) /* WIFI MACTIMER IRQ (WIFI MAC TX/RX Timer interrupt) */
        #define WIFI_MACTIMER_IRQ_IRQn          ((IRQn_Type) 24) /* WIFI MACTIMER IRQ (WIFI MAC TX/RX Timer interrupt) */
        #define VECTOR_NUMBER_WIFI_MACRX_IRQ ((IRQn_Type) 25) /* WIFI MACRX IRQ (WIFI MAC RX Trigger interrupt) */
        #define WIFI_MACRX_IRQ_IRQn          ((IRQn_Type) 25) /* WIFI MACRX IRQ (WIFI MAC RX Trigger interrupt) */
        #define VECTOR_NUMBER_WIFI_MACTX_IRQ ((IRQn_Type) 26) /* WIFI MACTX IRQ (WIFI MAC TX Trigger interrupt) */
        #define WIFI_MACTX_IRQ_IRQn          ((IRQn_Type) 26) /* WIFI MACTX IRQ (WIFI MAC TX Trigger interrupt) */
        #define VECTOR_NUMBER_WIFI_MACPROT_IRQ ((IRQn_Type) 27) /* WIFI MACPROT IRQ (WIFI MAC Protocol Trigger interrupt) */
        #define WIFI_MACPROT_IRQ_IRQn          ((IRQn_Type) 27) /* WIFI MACPROT IRQ (WIFI MAC Protocol Trigger interrupt) */
        #define VECTOR_NUMBER_WIFI_MACINTGEN_IRQ ((IRQn_Type) 28) /* WIFI MACINTGEN IRQ (WIFI MAC General interrupt) */
        #define WIFI_MACINTGEN_IRQ_IRQn          ((IRQn_Type) 28) /* WIFI MACINTGEN IRQ (WIFI MAC General interrupt) */
        #define VECTOR_NUMBER_WIFI_MACBCN_IRQ ((IRQn_Type) 29) /* WIFI MACBCN IRQ (WIFI MAC Beacon Reception interrupt) */
        #define WIFI_MACBCN_IRQ_IRQn          ((IRQn_Type) 29) /* WIFI MACBCN IRQ (WIFI MAC Beacon Reception interrupt) */
        #define VECTOR_NUMBER_WIFI_RC_IRQ ((IRQn_Type) 30) /* WIFI RC IRQ (WIFI Radio Controller interrupt) */
        #define WIFI_RC_IRQ_IRQn          ((IRQn_Type) 30) /* WIFI RC IRQ (WIFI Radio Controller interrupt) */
#else
/* Vector table allocations */
#define VECTOR_NUMBER_DMACW_IRQ ((IRQn_Type) 0) /* DMACW IRQ (General Purpose DMA interrupt) */
#define DMACW_IRQ_IRQn          ((IRQn_Type) 0) /* DMACW IRQ (General Purpose DMA interrupt) */
...
#define VECTOR_NUMBER_SPIW1_IRQ ((IRQn_Type) 7) /* SPIW1 IRQ (Generic interrupt) */
#define SPIW1_IRQ_IRQn          ((IRQn_Type) 7) /* SPIW1 IRQ (Generic interrupt) */
