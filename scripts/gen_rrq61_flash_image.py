...
from rrq61_get_flash_settings import get_reg_setting
import os
from os import path
import re
...
FSP_regvVlues = namedtuple('FSP_regvVlues',['ctrlmode_reg', 'burstcmda_reg', 'burstcmdb_reg'])
...
def gen_flash_image(in_file, out_file, ra6w_grp):
    ...
    fsp_reg = get_reg_setting()
    if fsp_reg.ctrlmode_reg == 0:
        burstcmda_reg_value = 0xa8a500eb
        burstcmdb_reg_value = 0x00030616
        ctrlmode_reg_value  = 0xF8000532
        flash_config_value  = b'\x02\x31\x02'
    else:
        burstcmda_reg_value = fsp_reg.burstcmda_reg
        burstcmdb_reg_value = fsp_reg.burstcmdb_reg
        ctrlmode_reg_value  = fsp_reg.ctrlmode_reg
        flash_config_value  = fsp_reg.flash_config
    ...
    ph_values = ProductHeaderValues(
        ...
        burstcmda_reg=burstcmda_reg_value,
        burstcmdb_reg=burstcmdb_reg_value,
        ctrlmode_reg=ctrlmode_reg_value,
        flash_config=flash_config_value,
    )
