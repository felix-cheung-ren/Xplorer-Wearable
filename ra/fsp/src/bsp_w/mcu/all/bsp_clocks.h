...
/* The following definitions are macros instead of enums because the values are used in preprocessor conditionals. */
 ...
 #define BSP_CLOCKS_SOURCE_CLOCK_PLL           3 /* also value for CLK_CTRL_REG.SYS_CLK_SEL */
 #define BSP_CLOCKS_SOURCE_CLOCK_RCX           4
#endif
...
/* OQSPI clock output divider options. */
#define BSP_CLOCKS_OQSPI_CLK_DIV_1           (0U) // OQSPI clock divided by 1.
#define BSP_CLOCKS_OQSPI_CLK_DIV_2           (1U) // OQSPI clock divided by 2.
#define BSP_CLOCKS_OQSPI_CLK_DIV_4           (2U) // OQSPI clock divided by 4.
#define BSP_CLOCKS_OQSPI_CLK_DIV_8           (3U) // OQSPI clock divided by 8.
