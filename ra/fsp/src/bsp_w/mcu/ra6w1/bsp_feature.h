...
#define BSP_FEATURE_CGC_HAS_LP_CLOCK                     (1U)
 ...
 */
#define BSP_FEATURE_OSPI_DEVICE_0_START_ADDRESS          (0x0A000000U)
#define BSP_FEATURE_OSPI_DEVICE_0_START_ADDRESS_DATA     (0x2A000000U)
#define BSP_FEATURE_OSPI_MAX_CHANNEL                     (1U)
#define BSP_FEATURE_OSPI_REG_FIELD_PREFIX                OSPIC_
#define BSP_FEATURE_FLASH_DATA_FLASH_START               (BSP_FEATURE_OSPI_DEVICE_0_START_ADDRESS_DATA | 0x00300000U)
