...
/// Flash read is failed.
#define OTA_FLASH_READ_FAILED       0xf2
/// Wrong certificate in secure boot.
#define OTA_SB_CERT_ERROR           0xf3
/// Failed to read LCS in secure boot.
#define OTA_SB_LCS_READ_ERROR       0xf4
/*******************************************************************/
