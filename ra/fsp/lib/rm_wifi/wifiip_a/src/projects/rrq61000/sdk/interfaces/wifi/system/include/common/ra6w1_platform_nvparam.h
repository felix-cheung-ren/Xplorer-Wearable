...
#define NVEE_LEN_MQTT_BROKER                (128	 + PARAM_STR_EXTRA)
#define NVEE_LEN_MQTT_QOS                   STR_INT32_LEN
#define NVEE_LEN_MQTT_SUB_TOPIC             (128 + PARAM_STR_EXTRA)
#define NVEE_LEN_MQTT_SUB_TOPIC0            (128 + PARAM_STR_EXTRA)
#define NVEE_LEN_MQTT_SUB_TOPIC1            (128 + PARAM_STR_EXTRA)
#define NVEE_LEN_MQTT_SUB_TOPIC2            (128 + PARAM_STR_EXTRA)
#define NVEE_LEN_MQTT_SUB_TOPIC3            (128 + PARAM_STR_EXTRA)
#define NVEE_LEN_MQTT_SUB_TOPIC_NUM         STR_INT32_LEN
#define NVEE_LEN_MQTT_PUB_TOPIC             (128 + PARAM_STR_EXTRA)
